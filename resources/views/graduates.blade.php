        ...
        <div class="pt-20 my-8 md:flex md:pt-0 md:gap-10">
            <div class="flex-1 max-w-5xl">
                <p class="text-gray-400">
                    Здесь вы можете выбрать специалиста из числа наших психологов по цене сессии до 2500 рублей. Все
                    психологи данного раздела прошли наш 1,5-годичный курс по психологическому консультированию и
                    обладают необходимыми навыками для предоставления качественной психологической помощи. Мы отбираем
                    специалистов по опыту, образованию и часам супервизии, и можем смело рекомендовать каждого.
            ...
            @if (isset($graduates))
                @foreach ($graduates as $graduate)
                    @if ($graduate->main_image_path)
                        <a href="{{ route('graduate.show', $graduate->id) }}" class="block col-span-2 break-inside-avoid">
                            <div
                        ...
                        @else
                            <a href="{{ route('graduate.show', $graduate->id) }}" class="block break-inside-avoid">
                    @endif
